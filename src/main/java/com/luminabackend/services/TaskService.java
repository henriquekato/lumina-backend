...
public class TaskService {
    ...
    public List<Task> getAllTasks(UUID classroomId, UserPermissionDTO userPermissionDTO) {
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
        return repository.findAllByClassroomId(classroomId);
    }

    public Page<Task> getPaginatedClassroomTasks(UUID classroomId, UserPermissionDTO userPermissionDTO, Pageable page) {
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
    ...
    public Task getTaskBasedOnUserPermission(UUID taskId, UUID classroomId, UserPermissionDTO userPermissionDTO){
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
    ...
    public Task save(UUID classroomId, UserPermissionDTO userPermissionDTO, TaskCreateDTO taskCreateDTO) {
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
    ...
    public Task edit(UUID taskId, UUID classroomId, UserPermissionDTO userPermissionDTO, TaskPutDTO taskPutDTO) {
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
    ...
    public void deleteById(UUID taskId, UUID classroomId, UserPermissionDTO userPermissionDTO) {
        Classroom classroom = classroomService.getClassroomById(classroomId);
        permissionService.checkAccessToClassroom(classroom, userPermissionDTO);
